...
time_cut_ratios = [0.3]  # OBS TEMP TIME_CUT - 0.3 used as frame
for i in range(len(time_cut_ratios)):
	...
	# TODO: Create feature importance plot: Each feature and how impurity changes with TIME_CUT
